...
// Function to render menu items dynamically based on given items
function renderMenuItems(items) {

  // Get the menu container element
  const menuContainer = document.getElementById('menu-items');

  // Clear any existing content inside the menu container
  ...
  items.forEach(item => {
    ...
    // Append the card HTML to the menu container
...
// Function to search menu items based on title
function searchMenu() {
...
// Event listener to render menu items when the DOM content is loaded
